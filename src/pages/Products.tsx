...
const Products = () => {
      ...
      {filteredAndSortedProducts.length > 0 ? (
        filteredAndSortedProducts.map(product => (
          viewMode === 'grid' ? (
            ...
            <div 
              key={product.id} 
              className="group flex bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden border border-gray-100"
            >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-50 pb-16">
          ...
          <div>
              ...
              <div className="flex flex-wrap gap-3 items-center">
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 border border-gray-200 hover:border-purple-300 text-gray-700 font-medium py-2 px-4 rounded-lg transition-colors"
                  >
                    <Filter size={16} />
                    Filter & Sort
                  </button>
                ...
                <div className="relative w-full md:w-64">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-200 focus:border-purple-400 focus:ring-2 focus:ring-purple-100 transition-all"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center mb-6">
              <div className="text-sm text-gray-500">
                ...
                {genderFilter !== 'all' && (
                  <span> filtered by <span className="font-medium text-purple-700">{genderFilter}</span></span>
                )}
                {searchTerm && (
                  <span> matching "<span className="font-medium text-purple-700">{searchTerm}</span>"</span>
                )}
              </div>
            </div>
