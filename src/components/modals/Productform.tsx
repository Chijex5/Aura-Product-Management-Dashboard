...
const ProductForm: React.FC<ProductFormProps> = ({ 
  ...
  return (
    <div className="bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-6 mb-8 border border-purple-100">
            ...
            {formData.imageFile && !formData.image && (
              <div className="mt-4">
                <button
                  ...
                  className="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:bg-purple-300"
                >
                  {uploadingImage ? (
                    <>
